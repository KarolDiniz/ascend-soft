...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  { id: 'height_50k', title: 'Centenário do ar', hint: '50 mil e zero plano B.', icon: 'height_peak', category: 'altura' },
  { id: 'height_100k', title: 'Centenário do ar', hint: '100 mil e zero plano B.', icon: 'height_peak', category: 'altura' },
