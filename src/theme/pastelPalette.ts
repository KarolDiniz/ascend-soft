...
export const PLAYER_PASTEL = {
  ...
  bodyBot: '#9BB8C8',
  bodySolid: PASTEL.powder,
  bodyHi: rgba(PASTEL.white, 0.62),
  bodyShade: rgba('#7A9AA8', 0.38),
  blush: rgba(PASTEL.coral, 0.42),
  eyeFill: rgba(PASTEL.ink, 0.72),
  eyeLine: rgba(PASTEL.ink, 0.55),
  outline: rgba(PASTEL.inkSoft, 0.28),
  trail: PASTEL.seafoam as string,
  shadow: rgba(PASTEL.inkSoft, 0.14),
};
