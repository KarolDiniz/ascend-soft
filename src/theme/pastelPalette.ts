...
export const MATERIAL_PASTEL: Record<string, PastelMaterialColors> = {
  ...
  mochi: {
    fill: rgba(PASTEL.blush, 0.92),
    stroke: rgba(PASTEL.rose, 0.85),
    glow: rgba(PASTEL.blush, 0.4),
  ...
  glycerin: {
    fill: rgba(PASTEL.sky, 0.55),
    stroke: rgba(PASTEL.powder, 0.9),
    glow: rgba(PASTEL.sky, 0.45),
    particle: PASTEL.powder,
    spriteWash: rgba(PASTEL.sky, 0.32),
  },
  whipped: {
    fill: rgba(PASTEL.white, 0.96),
    stroke: rgba(PASTEL.blush, 0.75),
    glow: rgba(PASTEL.blush, 0.4),
    particle: PASTEL.white,
    spriteWash: rgba(PASTEL.white, 0.25),
  },
  kinetic: {
  ...
  iceSoap: {
    fill: rgba(PASTEL.powder, 0.7),
    stroke: rgba(PASTEL.sky, 0.92),
    glow: rgba(PASTEL.mist, 0.48),
    particle: PASTEL.sky,
    spriteWash: rgba(PASTEL.mist, 0.35),
  },
  clearSlime: {
    fill: rgba(PASTEL.mint, 0.42),
    stroke: rgba(PASTEL.seafoam, 0.85),
    glow: rgba(PASTEL.mint, 0.42),
    particle: PASTEL.seafoam,
    spriteWash: rgba(PASTEL.mint, 0.28),
  },
  butterSlime: {
